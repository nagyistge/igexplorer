...
class TopLikersViewController: UITableViewController ,PeoplesTableKind,SegueThing{
  ...
  // deinit {}
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.navigationItem.title = "Top Likers of " + self.igp.userName +  "'s Posts"
        
        let posts = self.igp.pd.ouMediaPosts // all we gots
        
        let (_myslikers,likerscount,likecount) = Instagram.computeFreqCountForLikers(posts)
