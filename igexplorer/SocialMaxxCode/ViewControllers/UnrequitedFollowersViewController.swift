...
class UnrequitedFollowersViewController: UIViewController, FollowersTableKind, SegueThing  {
  ...
  // deinit {}
    ...
    override func viewDidLoad() {
        ...
        self.navigationItem.title = "Unrequited Followers of " + self.igp.userName
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if  let abc = segue.destinationViewController as? HelpInfoViewController {
            abc.info = "Unrequited Info Goes Here"
        }
