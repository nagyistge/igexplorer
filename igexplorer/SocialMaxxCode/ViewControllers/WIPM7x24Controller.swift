...
class WIPM7x24Controller: UIViewController,DrawHistoOps{
    ...
    override func viewWillTransitionToSize(size: CGSize, withTransitionCoordinator coordinator: UIViewControllerTransitionCoordinator) {
        ...
        let quints = AlphaMatrix(m:mi.m)
        
       self.histo = drawHistoFromMatrix(frame:nf,qm:quints.matrix,colorfunc: DrawnHisto.aColorFunc )
...
//        
         histo = drawHistoFromMatrix(frame:histoReservedSpace,qm:quints.matrix, colorfunc: DrawnHisto.bColorFunc )
