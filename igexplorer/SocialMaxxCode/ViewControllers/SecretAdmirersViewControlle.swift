...
class SecretAdmirersViewController: UIViewController, FollowersTableKind ,SegueThing {
  ...
  // deinit {}
    ...
    override func viewDidLoad() {
        ...
        self.navigationItem.title = "Secret Admirers of " + self.igp.userName
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if  let abc = segue.destinationViewController as? HelpInfoViewController {
            abc.info = "Secret Admirers Info Goes Here"
        }
