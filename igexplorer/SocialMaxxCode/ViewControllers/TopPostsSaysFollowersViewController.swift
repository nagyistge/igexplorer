//
//  TopPostsSaysFollowersViewController
//  SocialMaxx
//
...
class TopPostsSaysFollowersViewController: UITableViewController,PostsTableKind{
  ...
  // deinit {}
    ...
    override func viewDidLoad() {
        ...
        let (_freqs,likecount) = Instagram.computeFreqCountOfFollowersLikesForPosts(self.igp)
        freqs = _freqs // unpack
        self.navigationItem.title = "Top Posts Says Followers of " + self.igp.userName
