...
class HeartlessCommentersViewController: UITableViewController ,PeoplesTableKind{
  ...
  // deinit {}
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.navigationItem.title = "Heartless Commenters- " + self.igp.userName +  "'s Posts"
        
        _ = self.igp.pd.ouMediaPosts // all we gots
        
        let (_myslikers,_,_) = Instagram.computeFreqCountForHeartlessCommenters(self.igp)
